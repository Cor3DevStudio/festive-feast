 ...
 * Validates the user's JWT here, then calls the Edge Function with the service_role key
 * and user_id in the body. This avoids 401s from the user JWT not reaching Supabase
 * (e.g. Vercel stripping Authorization, or gateway/JWT issues).
 */
